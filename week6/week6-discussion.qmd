...
# Rename bands with corresponding ones from metadata
...
```
```{r}
# Find difference in NBR

diff_nbr <- pre_nbr_rast - post_nbr_rast

plot(diff_nbr, main = "Difference of Cold-Springs Fire NBR", colNA= "black") #or
...
```{r}
# Set categories for severity and reclassify
